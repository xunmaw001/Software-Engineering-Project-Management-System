    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑测试人员</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">测试人员管理</li>
                        <li class="breadcrumb-item active">编辑测试人员</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">测试人员信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="ceshiPhone" name="ceshiPhone" class="form-control"
                                               onchange="ceshiPhoneChickValue(this)"  placeholder="测试人员手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>测试人员身份证号</label>
                                        <input id="ceshiIdNumber" name="ceshiIdNumber" class="form-control"
                                               onchange="ceshiIdNumberChickValue(this)"  placeholder="测试人员身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>测试人员照片</label>
                                        <img id="ceshiPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="ceshiPhotoupload"
                                               class="form-control-file">
                                        <input name="ceshiPhoto" id="ceshiPhoto-input" type="hidden">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>性别</label>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#ceshiPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('ceshiPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('ceshiPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("ceshi/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addceshi');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function ceshiPhoneChickValue(e){
        ...
        function ceshiIdNumberChickValue(e){
            var this_val = e.value || 0;
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                ceshiName: "测试人员姓名不能为空",
                ceshiPhone: "测试人员手机号不能为空",
                ceshiIdNumber: "测试人员身份证号不能为空",
                ceshiPhoto: "测试人员照片不能为空",
                sexTypes: "性别不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addceshi = window.sessionStorage.getItem("addceshi");
        if (addceshi != null && addceshi != "" && addceshi != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("ceshi/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
