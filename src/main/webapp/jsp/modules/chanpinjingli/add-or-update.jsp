    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑产品经理</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑产品经理</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">产品经理信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="chanpinjingliPhone" name="chanpinjingliPhone" class="form-control"
                                               onchange="chanpinjingliPhoneChickValue(this)"  placeholder="产品经理手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>产品经理身份证号</label>
                                        <input id="chanpinjingliIdNumber" name="chanpinjingliIdNumber" class="form-control"
                                               onchange="chanpinjingliIdNumberChickValue(this)"  placeholder="产品经理身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>产品经理照片</label>
                                        <img id="chanpinjingliPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="chanpinjingliPhotoupload"
                                               class="form-control-file">
                                        <input name="chanpinjingliPhoto" id="chanpinjingliPhoto-input" type="hidden">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>性别</label>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#chanpinjingliPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('chanpinjingliPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('chanpinjingliPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("chanpinjingli/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addchanpinjingli');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function chanpinjingliPhoneChickValue(e){
        ...
        function chanpinjingliIdNumberChickValue(e){
            var this_val = e.value || 0;
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                username: "required",
                password: "required",
                chanpinjingliName: "required",
                chanpinjingliPhone: "required",
                chanpinjingliIdNumber: "required",
                chanpinjingliPhoto: "required",
                sexTypes: "required",
            },
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                chanpinjingliName: "产品经理姓名不能为空",
                chanpinjingliPhone: "产品经理手机号不能为空",
                chanpinjingliIdNumber: "产品经理身份证号不能为空",
                chanpinjingliPhoto: "产品经理照片不能为空",
                sexTypes: "性别不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addchanpinjingli = window.sessionStorage.getItem("addchanpinjingli");
        if (addchanpinjingli != null && addchanpinjingli != "" && addchanpinjingli != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("chanpinjingli/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
