            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">产品经理登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="chanpinjingliName" name="chanpinjingliName" class="form-control"
                                               v-model="ruleForm.chanpinjingliName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="chanpinjingliPhone" name="chanpinjingliPhone" class="form-control"
                                               v-model="ruleForm.chanpinjingliPhone" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="chanpinjingliIdNumber" name="chanpinjingliIdNumber" class="form-control"
                                               v-model="ruleForm.chanpinjingliIdNumber" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>产品经理照片</label>
                                    <img id="chanpinjingliPhotoImg" width="100" height="100">
                                </div>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "chanpinjingli/info/" + id,
