            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">测试登记</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <input id="xiangmuId" name="xiangmuId" v-model="ruleForm.xiangmuId" readonly type="hidden">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xiangmuCeshiName" name="xiangmuCeshiName" class="form-control"
                                               v-model="ruleForm.xiangmuCeshiName" readonly>
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>模块状态</label>
                                    <input id="xiangmuCeshiValue" name="xiangmuCeshiValue" class="form-control"
                                           v-model="ruleForm.xiangmuCeshiValue" readonly>
                                </div>
...
<script>
    ...
    var vm = new Vue({
        ...
        beforeCreate: function () {
            ...
            if (id != null && id != "" && id != "null") {
                $.ajax({
                    type: "GET",
                    url: baseUrl + "xiangmuCeshi/info/" + id,
    ...
    function setContent() {
        ...
        if (ruleForm.xiangmuCeshiContent != null && ruleForm.xiangmuCeshiContent != 'null' && ruleForm.xiangmuCeshiContent != '') {
            var xiangmuCeshiContentUeditor = UE.getEditor('xiangmuCeshiContentEditor');
                xiangmuCeshiContentUeditor.ready(function () {
                    var mes = '' + ruleForm.xiangmuCeshiContent;
                    xiangmuCeshiContentUeditor.setContent(mes);
                    xiangmuCeshiContentUeditor.setDisabled('fullscreen');
            });
        }
    }
