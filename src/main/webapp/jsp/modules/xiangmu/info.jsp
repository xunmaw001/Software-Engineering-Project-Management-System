                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 级联表所有字段 -->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="xiangmuguanliyuanName" name="xiangmuguanliyuanName" class="form-control"
                                                   v-model="ruleForm.xiangmuguanliyuanName" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="xiangmuguanliyuanPhone" name="xiangmuguanliyuanPhone" class="form-control"
                                                   v-model="ruleForm.xiangmuguanliyuanPhone" readonly>
                                        </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input id="xiangmuguanliyuanIdNumber" name="xiangmuguanliyuanIdNumber" class="form-control"
                                                   v-model="ruleForm.xiangmuguanliyuanIdNumber" readonly>
                                        </div>


                                    <div class="form-group col-md-6">
                                        <label>项目管理人照片</label>
                                        <img id="xiangmuguanliyuanPhotoImg" width="100" height="100">
                                    </div>

                                        <div class="form-group col-md-6">
                                            <label>产品经理</label>
                                            <input id="chanpinjingliId" name="chanpinjingliId" class="form-control"
                                                   v-model="ruleForm.chanpinjingliId" readonly>
                                        </div>
                            ...
                            <!-- 本表所有字段 -->
                                ...
                                <input id="xiangmuguanliyuanId" name="xiangmuguanliyuanId" v-model="ruleForm.xiangmuguanliyuanId" readonly type="hidden">
                                <input id="xuqiuId" name="xuqiuId" v-model="ruleForm.xuqiuId" readonly type="hidden">
