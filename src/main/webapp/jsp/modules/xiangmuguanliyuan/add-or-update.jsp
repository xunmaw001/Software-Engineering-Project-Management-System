    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑项目管理员</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑项目管理员</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">项目管理员信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="xiangmuguanliyuanPhone" name="xiangmuguanliyuanPhone" class="form-control"
                                               onchange="xiangmuguanliyuanPhoneChickValue(this)"  placeholder="项目管理人手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>项目管理人身份证号</label>
                                        <input id="xiangmuguanliyuanIdNumber" name="xiangmuguanliyuanIdNumber" class="form-control"
                                               onchange="xiangmuguanliyuanIdNumberChickValue(this)"  placeholder="项目管理人身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>项目管理人照片</label>
                                        <img id="xiangmuguanliyuanPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="xiangmuguanliyuanPhotoupload"
                                               class="form-control-file">
                                        <input name="xiangmuguanliyuanPhoto" id="xiangmuguanliyuanPhoto-input" type="hidden">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>性别</label>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#xiangmuguanliyuanPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('xiangmuguanliyuanPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('xiangmuguanliyuanPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("xiangmuguanliyuan/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addxiangmuguanliyuan');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function xiangmuguanliyuanPhoneChickValue(e){
        ...
        function xiangmuguanliyuanIdNumberChickValue(e){
            var this_val = e.value || 0;
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            rules: {
                username: "required",
                password: "required",
                xiangmuguanliyuanName: "required",
                xiangmuguanliyuanPhone: "required",
                xiangmuguanliyuanIdNumber: "required",
                xiangmuguanliyuanPhoto: "required",
                sexTypes: "required",
            },
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                xiangmuguanliyuanName: "项目管理人姓名不能为空",
                xiangmuguanliyuanPhone: "项目管理人手机号不能为空",
                xiangmuguanliyuanIdNumber: "项目管理人身份证号不能为空",
                xiangmuguanliyuanPhoto: "项目管理人照片不能为空",
                sexTypes: "性别不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addxiangmuguanliyuan = window.sessionStorage.getItem("addxiangmuguanliyuan");
        if (addxiangmuguanliyuan != null && addxiangmuguanliyuan != "" && addxiangmuguanliyuan != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("xiangmuguanliyuan/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
