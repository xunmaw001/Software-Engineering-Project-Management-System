    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑开发人员</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">编辑开发人员</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">开发人员信息</h3>
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="kaifaPhone" name="kaifaPhone" class="form-control"
                                               onchange="kaifaPhoneChickValue(this)"  placeholder="开发人员手机号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>开发人员身份证号</label>
                                        <input id="kaifaIdNumber" name="kaifaIdNumber" class="form-control"
                                               onchange="kaifaIdNumberChickValue(this)"  placeholder="开发人员身份证号">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>开发人员照片</label>
                                        <img id="kaifaPhotoImg" src="" width="100" height="100">
                                        <input name="file" type="file" id="kaifaPhotoupload"
                                               class="form-control-file">
                                        <input name="kaifaPhoto" id="kaifaPhoto-input" type="hidden">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label>性别</label>
...
<script>
    ...
    function upload() {
        ...
        <!-- 当前表的文件上传 -->
        $('#kaifaPhotoupload').fileupload({
            url: baseUrl + 'file/upload',
            headers: {token: window.sessionStorage.getItem("token")},
            dataType: 'json',
            done: function (e, data) {
                var photoUrl= baseUrl + 'file/download?fileName=' + data.result.file;
                document.getElementById('kaifaPhotoImg').setAttribute('src',photoUrl);
                document.getElementById('kaifaPhoto-input').setAttribute('value',photoUrl);
            }
        });
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            httpJson("kaifa/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addkaifa');
    ...
    //数字检查
        <!-- 当前表的数字检查 -->
        function kaifaPhoneChickValue(e){
        ...
        function kaifaIdNumberChickValue(e){
            var this_val = e.value || 0;
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                username: "账户不能为空",
                password: "密码不能为空",
                kaifaName: "开发人员姓名不能为空",
                kaifaPhone: "开发人员手机号不能为空",
                kaifaIdNumber: "开发人员身份证号不能为空",
                kaifaPhoto: "开发人员照片不能为空",
                sexTypes: "性别不能为空",
            }
        }).form();
    }
    ...
    // 获取当前详情
    function getDetails() {
        var addkaifa = window.sessionStorage.getItem("addkaifa");
        if (addkaifa != null && addkaifa != "" && addkaifa != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("kaifa/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
