            ...
            <div class="row breadcrumb-bar">
                ...
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">开发人员登记</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <!-- 本表所有字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="kaifaName" name="kaifaName" class="form-control"
                                               v-model="ruleForm.kaifaName" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="kaifaPhone" name="kaifaPhone" class="form-control"
                                               v-model="ruleForm.kaifaPhone" readonly>
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input id="kaifaIdNumber" name="kaifaIdNumber" class="form-control"
                                               v-model="ruleForm.kaifaIdNumber" readonly>
                                    </div>

                                <div class="form-group col-md-6">
                                    <label>开发人员照片</label>
                                    <img id="kaifaPhotoImg" width="100" height="100">
                                </div>
