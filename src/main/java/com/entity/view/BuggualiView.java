 ...
 */
@TableName("bugguali")
public class BuggualiView extends BuggualiEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		/**
		* bug类型的值
		*/
		private String buggualiValue;
		/**
		* bug是否处理的值
		*/
		private String buggualiChuliValue;
	...
	public BuggualiView(BuggualiEntity buggualiEntity) {
		try {
			BeanUtils.copyProperties(this, buggualiEntity);
			...
			* 获取： bug类型的值
			*/
			public String getBuggualiValue() {
				return buggualiValue;
			}
			/**
			* 设置： bug类型的值
			*/
			public void setBuggualiValue(String buggualiValue) {
				this.buggualiValue = buggualiValue;
			}
			/**
			* 获取： bug是否处理的值
			*/
			public String getBuggualiChuliValue() {
				return buggualiChuliValue;
			}
			/**
			* 设置： bug是否处理的值
			*/
			public void setBuggualiChuliValue(String buggualiChuliValue) {
				this.buggualiChuliValue = buggualiChuliValue;
			}
